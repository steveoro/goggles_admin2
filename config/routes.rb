...
Rails.application.routes.draw do
  ...
  get 'best_results/goggles_cup_preview/base_timings', to: 'goggles_cup#base_timings', as: 'base_timings_goggles_cup_preview'
  ...
  post 'data_fix/add_team', to: 'data_fix#add_team', as: 'data_fix_add_team'
  delete 'data_fix/delete_team', to: 'data_fix#delete_team', as: 'data_fix_delete_team'
